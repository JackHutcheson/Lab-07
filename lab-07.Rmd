...
ggplot(data = evals, mapping = aes(x = score)) +
  geom_histogram() +
  geom_vline(aes(xintercept = mean(score)), colour = "red", size = 2)
```

*Based on the fact that the histogram is left/negatively skewed, this means that overall people are giving professors a high score between 4 and 5. The mean score is roughly 4.1 which is shown through the red vertical line.*
